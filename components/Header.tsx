...
export function Header() {
  ...
  return (
    <header className="bg-white px-2 py-3  shadow sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <div>
          <Image
            src="/10ms.png"
            alt="10MinuteSchool Logo"
            width={100}
            height={40}
          />
        </div>
        <div className="flex items-center gap-4">
          <button
            ...
            className="flex items-center gap-1 border border-gray-300 px-2 py-1 rounded cursor-pointer"
          >
            <span>
              <svg
                className=""
          ...
          <button className="px-6 py-1.5 bg-[#1CAB55] cursor-pointer rounded-md text-white text-sm">
            লগ-ইন
          </button>
        </div>
      </div>
